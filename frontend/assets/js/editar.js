...
function salvarAlteracoes() {
    ...
    salvarAlteracoesNaAPI(dadosAtualizados)
        .then(() => {
            mostrarAlerta('success', 'Alterações salvas com sucesso!');
            setTimeout(() => {
                if (confirm('Deseja continuar editando outros relatórios?')) {
                    cancelarEdicao();
                } else {
        ...
        .catch(error => {
            ...
            mostrarAlerta('warning', 'Alterações salvas localmente. Serão sincronizadas quando a conexão for restabelecida.');
        });
}
